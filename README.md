...
> **Note:** There's no `.env.example` in the repo yet. Consider adding one with the variable
> names above (and no real values) so new contributors know what to provide.
